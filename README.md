...
- **Team-Type Statistiken** mit visueller Verteilung
...
- **Live-Status Updates** in Echtzeit
- **Notfall-Stop Funktion** für alle Teams gleichzeitig
...
- **📊 Statistik-Reports** mit detaillierten Analysen
...
### **Erster Einsatz**
1. **Einsatzleiter** und **Einsatzort** eingeben
2. **Timer-Warnungen** konfigurieren (Standard: 10/20 Min)
3. **Teams erstellen** mit Namen, Hund, Hundeführer
4. **📱 Mobile Verbindung** einrichten (optional)
...
### **Timer-Steuerung**
```
F1-F10    → Team 1-10 Timer Start/Stop Toggle
F11       → Vollbild ein/aus
Esc       → Vollbild beenden/App schließen
```

### **Team-Management**
```
Strg+N    → Neues Team hinzufügen
Strg+E    → Daten exportieren
Strg+H    → Hilfe anzeigen
```

### **Interface**
```
Strg+T    → Theme umschalten (Light/Dark)
Enter     → Schnell-Notiz hinzufügen (im Notiz-Feld)
```
