@echo off
:: Git Tag erstellen mit Git Bash für Version 1.8.0
:: Startet automatisch den GitHub Actions Workflow

echo ================================================
echo  Git Tag Creator v1.8.0 - Git Bash Version
echo ================================================
echo.
...
echo Committing changes for v1.8.0...
git add .
git commit -m "Prepare release v1.8.0"
